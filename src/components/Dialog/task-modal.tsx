          ...
          >
            ...
            >
              <div className="flex items-start gap-[18px]">
                <div className="project w-[4px] h-[20px] rounded-[2px] bg-[#f05252]"></div>
                <div className="flex flex-col">
                  ...
                  <div className="flex items-center justify-start gap-[16px] mt-[28px]">
                    <ProjectItem
                      item={{ name: "AiVideo", color: "#F05252" }}
                      tight
                    />
                    <TagItem item={{ name: "easy", color: "#69D571" }} tight />
                  </div>
                </div>
              </div>
            </DialogPanel>
